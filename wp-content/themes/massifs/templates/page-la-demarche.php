	...
	?>
		...
		<section class="bande bande--editorial">
			<div class="bande__contenu">
				...
				// Extension absente : on ne rend pas de titre de section vide.
				if ( null !== $massifs_perimetres || null !== $massifs_fond || null !== $massifs_statuts || null !== $massifs_zones || null !== $massifs_meteo ) :
					?>
