...
| Zoom minimal d'étiquetage | **9** — pyramide étiquetée **z9–z12**, **aucune étiquette à z5–z8** | **Règle, pas réglage.** Région utile du référentiel, en pixels de toile : z5 **26 × 23**, z6 **53 × 47**, z7 **105 × 94**, z8 **211 × 187**. La règle de densité seule y donne déjà **0, 0, 0 et 1** étiquette : ce n'est donc pas elle qui vide z5–z7, c'est la géométrie. Reste le seul candidat de z8 — et « Aix-en-Provence », cuit à 19 px, mesure **137 px**, soit **65 % de la largeur utile** : un seul mot en occuperait plus de la moitié. Le seuil supprime donc **exactement une** étiquette, et l'absence à z5–z8 est une **décision**, pas un manque. La recette l'asserte en deux temps, sur les zooms **5, 6, 7 et 8 écrits en clair** : « toponymes : aucune étiquette à z5–z8 (§3, règle et non réglage) », puis « toponymes : le seuil d'étiquetage réglé vaut le seuil normatif z9 ». Le second existe parce que le premier ne suffit pas seul : abaisser `zoom_min_etiquettes` renommerait un contrôle dont la plage serait dérivée, au lieu de le faire rougir. |
