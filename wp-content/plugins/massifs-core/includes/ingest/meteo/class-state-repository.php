<?php
/**
 * État opérationnel du connecteur météo : tentatives, échecs, alertes, journal.
 *
 * Cet état ne contient JAMAIS de niveau de danger : il décrit uniquement la
 * santé de la récupération. Les données vivent dans `SnapshotRepository`, et le
 * niveau ne quitte jamais la couche de lecture.
 *
 * @package Massifs
...
final class StateRepository {
	 ...
	 */
	public const OPTION = 'massifs_meteo_etat';
	 ...
	 *
	 * Un 404 n'est pas un échec : c'est le SEUL signal de non-publication de la
	 * source, et le compter ferait alerter sur une journée simplement pas encore
	 * publiée.
	 */
	 ...
	 */
	public const ALERTES = array( 'panne', 'rejet' );
	 ...
	 * @param string         $detail   Détail court, non échappé, SANS valeur de niveau.
	...
	/**
	 * Enregistre un marqueur d'état stable (désactivé, hors période).
	 *
	...
	/**
	 * Élague les verrous d'alerte trop anciens : l'option ne doit pas croître
	 * sans borne.
	 *
	 ...
	 * couvre largement la fenêtre du garde-fou anti-rafale.
	 *
	 * @param string $date_ymd Date de validité visée.
	 */
