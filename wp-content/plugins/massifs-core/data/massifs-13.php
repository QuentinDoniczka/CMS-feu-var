...
return array(
	'schema'                => 2,
	'genere_le'             => '2026-08-20T06:34:29Z',
	'source'                => array(
	...
	'communes'              => array(
		...
		'crs'              => 'EPSG:4326',
		'departements'     => array( '13', '83', '84', '30' ),
		'licence'          => array(
			'nom'         => 'Licence Ouverte',
			'version'     => '2.0',
			'identifiant' => 'etalab-2.0',
		...
		'attribution'      => array(
			'phrase'        => 'Source : IGN — ADMIN EXPRESS COG Carto 2026 (édition du 1er janvier 2026), via data.gouv.fr — Licence Ouverte 2.0',
			'phrase_courte' => 'IGN — ADMIN EXPRESS COG Carto 2026 — Licence Ouverte 2.0',
			'lien_source'   => 'https://www.data.gouv.fr/datasets/admin-express/',
			'lien_licence'  => 'https://www.etalab.gouv.fr/wp-content/uploads/2017/04/ETALAB-Licence-Ouverte-v2.0.pdf',
		),
		'seuil_massif_pct' => 1,
		'plafond_m'        => 5000,
		'source_liste'     => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
		'archive'          => array(
			'fichier'     => 'includes/domain/massifs/build/source/communes-13-limitrophes.geojson',
			'sha256'      => '43cc1925904fd08d14a03a22c8fd3d956c023d004acd6ac90f7c8ced7e1626cc',
			'octets'      => 1494991,
			'recupere_le' => '2026-08-18T22:27:38Z',
		),
		'lookup'           => array(
			'fichier'             => 'includes/domain/massifs/communes-13.lookup.json',
			'sha256'              => '53c4b91e82b282a733e8a7371d2110e29eaf661131122f0c12fe0273eac86f47',
			'octets'              => 501375,
			'nombre'              => 298,
			'sommets'             => 27890,
			'algorithme'          => 'douglas-peucker',
	...
	'lacunes'               => array(
		'communes' => array(
			'statut'            => 'calculee',
			'raison'            => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'source_pressentie' => 'IGN ADMIN EXPRESS COG Carto 2026',
		),
	),
	...
	'massifs'               => array(
		'alpilles'             => array(
			...
			'libelle'         => 'Alpilles',
			'tri'             => 'alpilles',
			'communes'        => array( 'Saint-Rémy-de-Provence', 'Eyguières', 'Orgon', 'Eygalières', 'Fontvieille', 'Maussane-les-Alpilles', 'Les Baux-de-Provence', 'Mouriès', 'Saint-Étienne-du-Grès', 'Aureille', 'Paradou', 'Lamanon', 'Tarascon', 'Saint-Martin-de-Crau', 'Sénas' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
				'ouest' => 4.65642,
		...
		'arbois'               => array(
			...
			'libelle'         => 'Arbois',
			'tri'             => 'arbois',
			'communes'        => array( 'Aix-en-Provence', 'Cabriès', 'Vitrolles', 'Velaux', 'Ventabren', 'Rognac', 'Les Pennes-Mirabeau', 'Berre-l\'Étang', 'Bouc-Bel-Air' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'calanques'            => array(
			...
			'libelle'         => 'Calanques',
			'tri'             => 'calanques',
			'communes'        => array( 'Marseille', 'Cassis' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'cap-canaille'         => array(
			...
			'tri'             => 'cap-canaille',
			'communes'        => array( 'La Ciotat', 'Cassis' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'castillon'            => array(
			...
			'libelle'         => 'Castillon',
			'tri'             => 'castillon',
			'communes'        => array( 'Saint-Mitre-les-Remparts', 'Fos-sur-Mer', 'Martigues', 'Istres', 'Port-de-Bouc' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'chaine-des-cotes'     => array(
			...
			'communes'        => array( 'Lambesc', 'Rognes', 'La Roque-d\'Anthéron', 'Charleval', 'Vernègues', 'Mallemort' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'chambremont'          => array(
			...
			'libelle'         => 'Chambremont',
			'tri'             => 'chambremont',
			'communes'        => array( 'Saint-Martin-de-Crau', 'Arles', 'Mouriès' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'collines-de-gardanne' => array(
			...
			'communes'        => array( 'Gardanne', 'Fuveau', 'Mimet', 'Simiane-Collongue', 'Gréasque' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'concors'              => array(
			...
			'libelle'         => 'Concors',
			'tri'             => 'concors',
			'communes'        => array( 'Jouques', 'Saint-Paul-lès-Durance', 'Vauvenargues', 'Meyrargues', 'Peyrolles-en-Provence', 'Saint-Marc-Jaumegarde', 'Venelles', 'Aix-en-Provence' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'cote-bleue'           => array(
			...
			'libelle'         => 'Cote Bleue',
			'tri'             => 'cote-bleue',
			'communes'        => array( 'Martigues', 'Ensuès-la-Redonne', 'Le Rove', 'Châteauneuf-les-Martigues', 'Les Pennes-Mirabeau', 'Sausset-les-Pins', 'Carry-le-Rouet', 'Marseille' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'etoile'               => array(
			...
			'libelle'         => 'Etoile',
			'tri'             => 'etoile',
			'communes'        => array( 'Simiane-Collongue', 'Marseille', 'Septèmes-les-Vallons', 'Allauch', 'Mimet', 'Plan-de-Cuques', 'Cadolive', 'Saint-Savournin', 'Bouc-Bel-Air' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'garlaban'             => array(
			...
			'libelle'         => 'Garlaban',
			'tri'             => 'garlaban',
			'communes'        => array( 'Allauch', 'Aubagne', 'Roquevaire', 'Peypin', 'Marseille', 'La Destrousse' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'grand-caunet'         => array(
			...
			'tri'             => 'grand-caunet',
			'communes'        => array( 'Roquefort-la-Bédoule', 'Ceyreste', 'Aubagne', 'Cassis', 'Cuges-les-Pins', 'La Ciotat', 'La Penne-sur-Huveaune', 'Gémenos', 'Carnoux-en-Provence' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'lancon'               => array(
			...
			'libelle'         => 'Lançon',
			'tri'             => 'lancon',
			'communes'        => array( 'Lançon-Provence', 'Saint-Chamas', 'La Fare-les-Oliviers', 'Cornillon-Confoux' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'les-roques'           => array(
			...
			'libelle'         => 'Les Roques',
			'tri'             => 'les-roques',
			'communes'        => array( 'Salon-de-Provence', 'Aurons', 'Vernègues', 'Lambesc', 'Alleins', 'Pélissanne', 'Lamanon', 'Mallemort' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'montagnette'          => array(
			...
			'libelle'         => 'Montagnette',
			'tri'             => 'montagnette',
			'communes'        => array( 'Barbentane', 'Boulbon', 'Tarascon', 'Graveson' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'montaiguet'           => array(
			...
			'libelle'         => 'Montaiguet',
			'tri'             => 'montaiguet',
			'communes'        => array( 'Meyreuil', 'Aix-en-Provence', 'Bouc-Bel-Air', 'Gardanne' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'pont-de-rhaud'        => array(
			...
			'tri'             => 'pont-de-rhaud',
			'communes'        => array( 'Grans', 'Miramas', 'Cornillon-Confoux', 'Saint-Chamas', 'Salon-de-Provence' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'quatre-termes'        => array(
			...
			'tri'             => 'quatre-termes',
			'communes'        => array( 'La Barben', 'Éguilles', 'Lançon-Provence', 'Lambesc', 'Saint-Cannat', 'Coudoux', 'Ventabren', 'Pélissanne', 'Aix-en-Provence' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'regagnas'             => array(
			...
			'libelle'         => 'Regagnas',
			'tri'             => 'regagnas',
			'communes'        => array( 'Trets', 'Peynier', 'Belcodène', 'Auriol', 'La Bouilladisse', 'Fuveau', 'Peypin', 'Gréasque', 'Saint-Savournin' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'rougadou'             => array(
			...
			'libelle'         => 'Rougadou',
			'tri'             => 'rougadou',
			'communes'        => array( 'Noves', 'Châteaurenard' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'sainte-baume'         => array(
			...
			'tri'             => 'sainte-baume',
			'communes'        => array( 'Cuges-les-Pins', 'Gémenos', 'Auriol', 'Roquevaire' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'sainte-victoire'      => array(
			...
			'tri'             => 'sainte-victoire',
			'communes'        => array( 'Vauvenargues', 'Puyloubier', 'Saint-Antonin-sur-Bayon', 'Châteauneuf-le-Rouge', 'Beaurecueil', 'Le Tholonet', 'Saint-Marc-Jaumegarde', 'Rousset', 'Aix-en-Provence', 'Meyreuil' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
		...
		'trevaresse'           => array(
			...
			'libelle'         => 'Trevaresse',
			'tri'             => 'trevaresse',
			'communes'        => array( 'Rognes', 'Le Puy-Sainte-Réparade', 'Aix-en-Provence', 'Saint-Cannat', 'Venelles', 'Lambesc', 'Saint-Estève-Janson', 'Meyrargues' ),
			'communes_source' => 'calculée par intersection des périmètres DDTM avec IGN ADMIN EXPRESS COG Carto 2026, seuil de 1 % de la surface du massif',
			'actif'           => true,
			'retire_le'       => null,
			'bbox'            => array(
