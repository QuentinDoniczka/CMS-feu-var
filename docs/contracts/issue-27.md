...
> assertion 4 de la table « Attendus mesurables », la précision de la phrase « provablement dépourvu
> de chiffre » du §« La garantie structurelle du chiffre », et le **critère de revue de l'arbitrage
> A-32**, qui énonçait la même règle sans borner sa portée — pris à la lettre, il faisait de
> `$massifs_ardoise_absente` un défaut alors que A-32 le décide et que A-35 impose son URL.
> **Aucun octet de code n'est modifié par #31.**
