...
| 3 | Mobile réel 360 px — carte, panneaux, liste, écran gestionnaire | **partielle** | Débordement horizontal **nul** sur les 5 pages relevées, **à 360 px et à 320 px**, valeurs consignées (§7.1 et [`captures/`](captures/)). Le §8 du brief nomme 320 px : c'est mesuré. L'écran gestionnaire n'est pas dans cette passe ; il est couvert par le scénario `portail` du harnais de lot. « Mobile réel » reste un émulateur ici |
